...
function About(){
    ...
    return(
        <div className='about' id='about'>
            ...
            <p>Hi, I'm Brian, a Computer Science student at Penn State University with a strong passion for programming, problem-solving, and learning new technologies. With two internships under my belt, I've gained hands-on experience
